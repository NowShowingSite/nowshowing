...
type View = { kind: "list" } | { kind: "results"; name: string };
...
export default function CollectionsButton({
  ...
  return (
    <>
      <button className="collections-trigger-btn" onClick={handleOpen}>
        Collections
      </button>
      ...
      {open && (
        ...
        >
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {view.kind === "results" && (
              <>
                <span className="decade-back" onClick={() => setView({ kind: "list" })}>
                  ← All collections
                </span>
