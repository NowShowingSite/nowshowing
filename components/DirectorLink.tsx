...
type DirectorMovie = { id: string; slug: string; title: string; year: number | null; avg: number | null };
...
export default function DirectorLink({
  ...
  const [movies, setMovies] = useState<DirectorMovie[] | null>(null); // null = loading
  ...
  return (
    <>
      <span className="director-link" onClick={handleOpen}>
        {name}
      </span>
      ...
      {open && (
        <div className="modal-overlay" onClick={() => setOpen(false)}>
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-subtitle">Movies on this site</p>
